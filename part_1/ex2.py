...
#draw sun
Yellow=(255, 255, 0)
pygame.draw.ellipse(s, Yellow, (300, 10, 380, 380), 20)
pygame.draw.line(s, Yellow, (300, 200), (680, 200),20)
pygame.draw.line(s, Yellow, (490, 10), (490, 390),20)
#draw world
pygame.draw.rect(screen,(211, 211, 211, 0),(0, 400, 800, 400))
pygame.draw.rect(screen,(135, 206, 235, 0),(0, 0, 800, 400))
pygame.draw.line(screen, (0, 0, 0, 0), (0, 400), (800, 400), 1)
draw_bear(200, 500, 300)
screen.blit(s, (0,0))    
